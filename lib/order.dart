...
class Listfood extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 10),
          buildItemRow(
              "Burger King Large", "Rp 50.000", "assets/burger1.jpeg", context),
          SizedBox(height: 10),
          buildSeparator(),
          SizedBox(height: 10),
          ...
          buildSeparator(),
          SizedBox(height: 10),
          buildItemRow("Burger king medium", "Rp 30.000", "assets/burger1.jpeg",
              context),
          SizedBox(height: 10),
        ],
      ),
  ...
  Widget buildItemRow(
      String productName, String price, String image, BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        ClipRRect(
